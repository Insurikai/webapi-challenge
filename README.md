...
- [ ] Describe Middleware?
  Middleware are functions which can be called before a response is returned, they typically perform some operation(s) based on the request object.
- [ ] Describe a Resource?
  The information within the database. More generally a resource is the information the server has which the client is requesting.
- [ ] What can the API return to help clients know if a request was successful?
  A status code. 200 (Generic), 201 (Created), etc
- [ ] How can we partition our application into sub-applications?
  By using Express router and node modules (exports)
